---
language: "en"
title: "What is a Chip? The Simplest Explanation to Start Your Hardware Journey"
categories:
  - "Chip Design"
tags:
  - "Chips"
...
When talking about the world of chips, it's very easy to get lost.
ASIC, SoC, RTL, transistors - everything sounds like you need a degree in electrical engineering to understand.
...
A chip is a very small component -
that contains tiny electrical circuits performing tasks.
...
**In software** - you "write code" that runs on a computer.
**In chips** - you describe logic that will eventually become actual hardware.

Software can be changed at any moment.
Hardware - almost impossible to change after manufacturing.
...
From here, we'll slowly and clearly build all hardware concepts.
