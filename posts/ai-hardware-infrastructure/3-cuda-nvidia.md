...
NVIDIA שינתה את זה כשהשיקה את **CUDA** - ומעצם השקתה, עולם ה-AI השתנה.
...
אחרי CUDA - הופיעו PyTorch ו-TensorFlow, והכלים האלה החלו להשתמש ב-GPU ישירות.

זה היה המפתח:
לא צריך יותר לדעת את CUDA עצמה -
...
3. המכפלה מחושבת בצורה מקבילית על אלפי ליבות.
4. התוצאה חוזרת אליך.
...
- **ROCm** - של AMD, תומכת בכרטיסים שלה.
